                ...
                <div class="row gy-4 text-center">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item bg-white p-4 rounded-4 shadow-sm h-100 transition-hover" data-aos="zoom-in"
                            ...
                            <h3 class="purecounter text-dark fw-bold" data-purecounter-start="0"
                                data-purecounter-end="12" data-purecounter-duration="1">0</h3>
                    ...
                    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-hadroh">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('frontend/assets/img/ekstrakulikuler/hadroh.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>Hadroh</h4>
                                    <p>Ekstrakulikuler Hadroh</p>
                                    <a href="{{ asset('frontend/assets/img/ekstrakulikuler/hadroh.jpg') }}" title="App 1"
            ...
            <div class="container">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <div class="pic"><img
                                    src="{{ asset('frontend/assets/img/team/H. Salman Al Farisi (Pengurus Pondok).jpg') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <div class="pic"><img
                                    src="{{ asset('frontend/assets/img/team/Kyai Akhmad Syaikhu, S.Ag (Pengurus Pondok).jpg') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <div class="pic"><img
                                    src="{{ asset('frontend/assets/img/team/H. Akhmad Khamdan (Pengurus Pondok).jpg') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
